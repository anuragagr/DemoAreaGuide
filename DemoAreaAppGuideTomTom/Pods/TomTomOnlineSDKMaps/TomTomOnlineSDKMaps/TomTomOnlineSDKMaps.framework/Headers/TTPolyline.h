 ...
 */
@interface TTPolyline : TTOverlay <TTCoordinatesData>

+ (instancetype _Nonnull)polylineWithCoordinatesData:(id<TTCoordinatesData> _Nonnull)coordinatesData
...
/**
 ...
 @return TTPolyline
 */
+ (instancetype _Nonnull)polylineWithCoordinates:(CLLocationCoordinate2D* _Nonnull)coordinates
