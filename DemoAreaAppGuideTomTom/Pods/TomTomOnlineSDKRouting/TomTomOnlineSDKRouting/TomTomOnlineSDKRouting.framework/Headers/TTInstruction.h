...
/**
 ...
 @deprecated This property is deprecated, use position instead.
 */
@property (nonatomic, readonly, strong) NSValue* point DEPRECATED_MSG_ATTRIBUTE("This property is deprecated, use position instead.");
